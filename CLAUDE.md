...
- **NEXT (optional)**: scheduled Container Apps Job (periodic pipeline runs), App Insights/OpenTelemetry. Stretch: Bing-grounded cross-shipment intelligence, dashboard.
